<template>
	<view class="container">
		<view class="title">
			<view :class="'title_item mobile ' + (channel==1 ? 'active' : '') " @click="channel==2?channel=1:''">手机找回</view>
			<view :class="'title_item email ' + (channel==2 ? 'active' : '') " @click="channel==1?channel=2:''">邮箱找回</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			submit(){
				...
				let _this= this;
				uni.request({
					url: _this.api_host + 'site/retieve-pwd',
					method: 'POST',
					header: {
